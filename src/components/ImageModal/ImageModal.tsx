...
const ImageModal = ({isOpen, onClose, photoDetails}:ImageModalProps) => {
  const {alt, src, likes, tags, description, download, user}:Photo = photoDetails || {};
  const tagsList = tags.map((tag:Tags) => ({
    ...tag,
